...
export const STATUS_META: Record<TaskStatus, { label: string; color: string; tint: string }> = {
  pending: { label: 'Pending tasks', color: 'bg-slate-400', tint: 'bg-slate-100 text-slate-700 dark:bg-slate-900/60 dark:text-slate-300' },
  assigned: { label: 'Assigned', color: 'bg-sky-500', tint: 'bg-sky-50 text-sky-700 dark:bg-sky-950/30 dark:text-sky-300' },
